# Exercise 5 · Add-on – From strings to type-safe constants

> **Prerequisite:** [Exercise 5](exercise-05.md) is complete – both process tests are green.
...
There is **no new model** – you are hardening the test from Exercise 5.
...
Run the tests from Exercise 5 again – the behavior must not have changed at all:
...
In Exercise 6 the process gets considerably richer: a subprocess, a timer, message boundary
