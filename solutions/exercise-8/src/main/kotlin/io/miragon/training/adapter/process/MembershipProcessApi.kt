...
object MembershipProcessApi {
    ...
    object Elements {
        ...
        const val BOUNDARY_COMPENSATE_CLAIM: String = "boundary_compensateClaim"
    }
    ...
    // Compensation: serviceTask_revokeClaim is an isForCompensation=true handler,
    // NOT on a sequence flow. It is triggered automatically when the Compensating
    // End Event (endEvent_membershipDeclined) fires.
