...
import org.cibseven.rest.client.model.StartProcessInstanceDto;
...
/**
 * Drives the shared, remote CIB seven engine over its REST API to start the owned {@code sendWelcomeKit}
 * process (Direction 2: worker -> engine). The REST call goes through the <strong>autogenerated,
 * typed</strong> client ({@link ProcessDefinitionApi} from {@code cibseven-engine-client}) rather than
