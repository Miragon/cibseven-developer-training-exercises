 ...
 *
 * <p>TODO Exercise 10: use the generated, typed client. Once the generator is active (see pom.xml) and
...
public class RemoteWelcomeKitProcessAdapter implements WelcomeKitProcess {
    ...
    public void startWelcomeKit(String memberName) {
        throw new UnsupportedOperationException(
                "TODO Exercise 10: start the process via the generated client (ProcessDefinitionApi)");
    }
}
