# Aufgabe 10 – Starter: `logistics-service`

> 🇩🇪 **Deutsch** · [🇬🇧 English](README.md)

Dies ist die **Vorlage** für den Logistik-Service aus Aufgabe 10 (Remote-Owner des `sendWelcomeKit`-Prozesses).
Sie liegt bewusst hier unter `templates/` und **nicht** in `services/` – so bleibt `services/` für die
Aufgaben 0–8 aufgeräumt.

## So legst du den Service in Aufgabe 10 an
...
3. Die `TODO Exercise 10`-Stellen ausfüllen (Details in [`docs/exercise-10.md`](../../../docs/de/exercise-10.md)):
...
Referenzlösung: [`solutions/exercise-10/logistics-service`](../../../solutions/exercise-10/logistics-service).

> Tipp: Die Vorlage kompiliert schon im Ausgangszustand (der Client-Teil ist auskommentiert). Zum Prüfen
> der Vorlage ohne Kopieren: `./mvnw -Pexercise-10 -pl templates/exercise-10/logistics-service compile`.
